          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-2">
              <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-study-100 text-study-800 mb-4">
                ...
                <span>Revolutionizing your study experience</span>
              </div>
              <h1 className="heading-xl text-foreground">
                Learn actively, <br />
                <span className="text-study-600">remember forever</span>
              </h1>
              <p className="subheading max-w-lg mt-4">
                Transform textbook learning with interactive quizzes and AI-generated questions tailored to your study material.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4 text-sm text-muted-foreground">
              ...
              <div>
                <span className="text-foreground font-medium">1,000+</span> students already learning
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-fade-in">
            <div className="aspect-square w-full max-w-md mx-auto lg:mx-0 lg:ml-auto">
              <div className="glass-card absolute top-0 left-0 p-6 w-48 animate-float shadow-lg">
                ...
                <p className="text-sm text-muted-foreground mt-1">Transform passive reading into active learning</p>
              </div>
              ...
              <div className="glass-card absolute bottom-10 right-0 p-6 w-48 animate-float animation-delay-1000 shadow-lg">
                ...
                <h3 className="font-medium">AI-Powered Questions</h3>
                <p className="text-sm text-muted-foreground mt-1">Custom questions from your study material</p>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden shadow-2xl bg-white">
                <div className="w-full h-full bg-gradient-to-br from-study-100 to-study-50 flex items-center justify-center p-8">
                  <div className="w-full max-w-sm glass-card p-8">
                    ...
                    <h3 className="text-xl font-semibold mb-3">Biology Chapter 4</h3>
